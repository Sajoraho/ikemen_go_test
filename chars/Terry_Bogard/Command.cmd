...
time = 32
;----------------
;----------------Buster Wolf LVL / OverHeat Geyser
[Command]
name = "BusterWolf"
...
time = 32
;----------------
;----------------MAX Buster Wolf / Max OverHeat Geyser
[Command]
name = "MAXBusterWolf"
...
value = 3700
triggerAll = !AILevel
triggerAll = command = "PowerStream"&&!var(40)
triggerAll = RoundState = 2 && StateType != A
...
value = 3500
triggerAll = !AILevel
triggerAll = command = "TrinityGeyser"&&var(40)
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 3000 && !var(20)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)
...
value = 3350
triggerAll = !AILevel
triggerAll = command = "MAXBusterWolf"&&!var(40)
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)
...
value = 3300
triggerAll = !AILevel
triggerAll = command = "BusterWolf"&&!var(40)
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)
...
value = 1330
triggerAll = !AILevel
triggerAll = command = "EXPowerDunk"&& !var(40)
triggerAll = RoundState = 2 && StateType != A
...
value = 1130
triggerAll = !AILevel
triggerAll = command = "EXRisingTackle"&& !var(40) &&ifElse(var(20) > 0 || (StateNo = 1130), 1, var(50) > 16)
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1130
triggerAll = !AILevel
triggerAll = command = "EXMEXRisingTackle"&& var(40)
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1630
triggerAll = !AILevel
triggerAll = command = "EXPowerCharge"&& !var(40)
triggerAll = RoundState=2 && StateType != A
triggerAll = Power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
triggerAll = !AILevel
triggerAll = command = "PowerDunk"&& !var(40)
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
trigger3=((stateno=[200,251])||(stateno=[400,450]))&&movecontact&&var(55)
...
value = 1100
triggerAll = !AILevel
triggerAll = command = "RisingTackle"&& !var(40) &&ifElse(var(20) > 0 || (StateNo = 1100), 1, var(50) > 16)
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
trigger3=((stateno=[200,251])||(stateno=[400,450]))&&movecontact&&var(55)
...
value = 1100
triggerAll = !AILevel
triggerAll = command = "EXMRisingTackle"&& var(40)
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
trigger3=((stateno=[200,251])||(stateno=[400,450]))&&movecontact&&var(55)
...
value = 1600
triggerAll = !AILevel
triggerAll = command = "PowerCharge"&& !var(40)  
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
trigger3=((stateno=[200,251])||(stateno=[400,450]))&&movecontact&&var(55)
