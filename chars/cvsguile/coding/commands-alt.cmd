...
triggerall = var(9)!=0 && roundstate = 2 && stateno = 5050
trigger1= vel y>-1 && alive && canrecover && random<20*var(9)
trigger2 = enemynear, authorname = "Kurai Naito" && StateNo = 679 && Time = 0
...
trigger4 = StateNo = 2200 && MoveHit && AnimElem = 34, = 0
trigger5 = Enemy, StateType != L
trigger6 = Enemy, Name = "Karin Kanzuki" && MoveType = A && P2Dist X > 50
trigger7 = Enemy, Name = "William F. Guile" && MoveType = A && P2Dist X > 50
value = 2500
